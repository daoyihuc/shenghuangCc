...
import com.daoyis.shennghuang.Views.ViewfinderView;
import com.daoyis.shennghuang.camera.CameraManager;
import com.daoyis.shennghuang.decoding.CaptureActivityHandler;
import com.daoyis.shennghuang.decoding.InactivityTimer;
...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			Log.e("daoyi",resultString);
			Log.e("daoyi",codetype);
			MipcaActivityCapture.this.finish();
		}
	}
